...
option(${PROJECT_NAME}_BUILD_DOCS "Enable SANITIZER_MEMORY for the ${PROJECT_NAME} project" ${${PARENT_PROJECT_NAME}_BUILD_DOCS})

option(${PROJECT_NAME}_SKIP_INSTALL_RULES "Skip install rules for the ${PROJECT_NAME} project"
       ${CMAKE_SKIP_INSTALL_RULES})

option(${PROJECT_NAME}_ENABLE_PCH "Enable precompiled headers for the ${PROJECT_NAME} project" ${${PARENT_PROJECT_NAME}_ENABLE_PCH})

option(${PROJECT_NAME}_BUILD_SHARED_LIBS "Select library type for the ${PROJECT_NAME} project" ${${PARENT_PROJECT_NAME}_BUILD_SHARED_LIBS})
